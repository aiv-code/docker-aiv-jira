...
--changeset author:1 date:20240825

CREATE EXTENSION IF NOT EXISTS intarray;

CREATE SCHEMA IF NOT EXISTS "Default";

CREATE TABLE IF NOT EXISTS "Default".ai_category
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_embed (
 id integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_fileandfolder
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_privilege
(
  id serial NOT NULL,
  fileid integer,
  ...
  CONSTRAINT ai_privilege_fileid_fkey FOREIGN KEY (fileid) REFERENCES "Default".ai_fileandfolder (id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_file_options
(
    id serial NOT NULL,
    fileid integer,
    privilegetype character varying(255),
    ...
    CONSTRAINT ai_file_options_fileid_fkey FOREIGN KEY (fileid) REFERENCES "Default".ai_fileandfolder (id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_anot_privilege
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_privilege_template
(
  id serial NOT NULL,
  privilegetype character varying(255),
  user_rolename character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_user
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_session
(
 id serial NOT NULL,
  username character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_department (
id serial NOT NULL,
deptName character varying(255),
deptCode character varying(255)
);

CREATE TABLE IF NOT EXISTS "Default".ai_request
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_request_task
(
  id serial NOT NULL,
  requestid integer,
  name character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_notification
(
  id serial NOT NULL,
  user_rolename character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_recurring_request
(
  id serial NOT NULL,
  requestid integer,
  username character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_request_parameter
(
  id serial NOT NULL,
  requestid integer,
  ...
  CONSTRAINT ai_request_parameter_requestid_fkey FOREIGN KEY (requestid)
      REFERENCES "Default".ai_request (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
);

CREATE TABLE IF NOT EXISTS "Default".ai_filetype
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_filetype_output
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_filefolder_output
(
  id serial NOT NULL,
  fileid integer,
  outputtype character varying(45),
  CONSTRAINT ai_filefolder_output_fileid_fkey FOREIGN KEY (fileid) REFERENCES "Default".ai_fileandfolder (id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_role
(
  id serial NOT NULL,
  name character varying(255),
  description character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_user_role
(
  id serial NOT NULL,
  userName character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_parameter
(
  id serial NOT NULL,
  name character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_quickrun
(
  id serial NOT NULL,
  name character varying(255),
  reportid integer,
...
CREATE TABLE IF NOT EXISTS "Default".ai_quickrun_parameter
(
  id serial NOT NULL,
  quickrunid integer,
  paramname character varying(255),
  ...
  CONSTRAINT ai_quickrun_parameter_quickrunid_fkey FOREIGN KEY (quickrunid)
      REFERENCES "Default".ai_quickrun (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_audit
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_email_users(
displayname character varying(255),
email character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_ldap_user_role
(
...
CREATE TABLE IF NOT EXISTS "Default".ai_quicklink
(
  id serial NOT NULL,
  owner character varying(255),
  name character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_dm
(
  id serial NOT NULL,
  type character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_dm_applicable_area
(
  id serial NOT NULL,
  dm_id integer,
...
CREATE TABLE IF NOT EXISTS "Default".ai_dm_detail
(
  id serial NOT NULL,
  dm_id integer,
...
CREATE TABLE IF NOT EXISTS "Default".ai_dm_privilege
(
  id serial NOT NULL,
  dm_id integer,
  privilegetype character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_usertype_map
(
  id serial NOT NULL,
  usertype character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_backupuser
(
  id serial NOT NULL,
  username character varying(255),
...
CREATE TABLE IF NOT EXISTS "Default".ai_im_comments
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_timezone
(
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_license
(
...
CREATE TABLE IF NOT EXISTS "Default".ai_event(
id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_event_request(
id serial NOT NULL,
event_id integer,
request_id integer,
CONSTRAINT ai_event_request_eventid_fkey FOREIGN KEY (event_id) REFERENCES "Default".ai_event (id) ON DELETE CASCADE,
CONSTRAINT ai_event_request_requestid_fkey FOREIGN KEY (request_id) REFERENCES "Default".ai_request (id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_event_mail(
id serial NOT NULL,
event_id integer,
entity character varying(10) NOT NULL,
recipient text NOT NULL,
CONSTRAINT ai_event_mail_id_fkey foreign key(event_id) REFERENCES "Default".ai_event (id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_external_db(
dbKey character varying(255),
dbName character varying(255) NOT NULL,
CONSTRAINT ai_extdb_pkey PRIMARY KEY (dbKey)
);

CREATE TABLE IF NOT EXISTS "Default".ai_extdb_priv(
id serial NOT NULL,
dbKey character varying(255),
privilegeType character varying(10) NOT NULL,
user_roleName character varying(255) NOT NULL,
CONSTRAINT ai_extdb_priv_fkey foreign key(dbKey) REFERENCES "Default".ai_external_db (dbKey) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "Default".ai_annotation (
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_lovrow_mapping(
id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_report_management(
id serial NOT NULL,
lovId integer DEFAULT NULL,
...
CONSTRAINT ai_report_management_lovId_fkey FOREIGN KEY (lovId) REFERENCES "Default".ai_fileandfolder(id),
CONSTRAINT ai_report_management_lovMappingId_fkey FOREIGN KEY (lovMappingId) REFERENCES "Default".ai_fileandfolder(id)
);

CREATE TABLE IF NOT EXISTS "Default".ai_datasource (
id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_datasource_type (
id serial NOT NULL,
protocol character varying(500),
...
CREATE TABLE IF NOT EXISTS "Default".ai_time_scheduler_cron (
  id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_alertSuccess
   (	id serial NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Default".ai_file_output (
 id serial NOT NULL,
 fileid integer,
 oid integer,
 status character varying(45) DEFAULT NULL,
 CONSTRAINT ai_file_output_pkey PRIMARY KEY (id),
 CONSTRAINT ai_file_output_fileid_fkey FOREIGN KEY (fileid) REFERENCES "Default".ai_fileandfolder(id)
);


CREATE TABLE IF NOT EXISTS "Default".ai_chathistory
(
    id serial NOT NULL,
...
insert into "Default".ai_category(id,category,folderPath)
...
SELECT SETVAL('"Default".ai_category_id_seq', (SELECT MAX(id) from "Default".ai_category));

INSERT INTO "Default".ai_filetype(id,isOutputType,fileType,longDescription)
...
SELECT SETVAL('"Default".ai_filetype_id_seq', (SELECT MAX(id) from "Default".ai_filetype));

INSERT INTO "Default".ai_filetype_output(id,fileType, outputType)
...
SELECT SETVAL('"Default".ai_filetype_output_id_seq', (SELECT MAX(id) from "Default".ai_filetype_output));

INSERT INTO  "Default".ai_usertype_map(id,userType,descriptionName)
values
(1,'INT','Advanced User'),
(2,'EXT','End User');

SELECT SETVAL('"Default".ai_usertype_map_id_seq', (SELECT MAX(id) from "Default".ai_usertype_map));

insert into "Default".ai_timezone values
...
SELECT SETVAL('"Default".ai_timezone_id_seq', (SELECT MAX(id) from "Default".ai_timezone));

insert into "Default".ai_user values
...
SELECT SETVAL('"Default".ai_user_id_seq', (SELECT MAX(id) from "Default".ai_user));

insert into "Default".ai_role values
(1,'Administrator','Administrator Role','Admin@aivhub.com',2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,'Default'),
(2,'Sales','Sales Role','support@aivhub.com',1,1,1,1,2,0,1,1,1,0,0,2,1,1,0,2,'Default');

SELECT SETVAL('"Default".ai_role_id_seq', (SELECT MAX(id) from "Default".ai_role));

insert into "Default".ai_user_role values
(1,'Demo','Sales'),
(2,'Admin','administrator');

SELECT SETVAL('"Default".ai_user_role_id_seq', (SELECT MAX(id) from "Default".ai_user_role));

insert into "Default".ai_dm (id,type,subject,description,owner,visibility,active,start_date,end_date,created_on,lastupdated_on,option1,option2,option3,option4,option5,option6,option7,option8,option9,option10) values
...
SELECT SETVAL('"Default".ai_dm_id_seq', (SELECT MAX(id) from "Default".ai_dm));

insert into "Default".ai_dm_applicable_area (dm_id,applicableto_area,applicableto_area_val) values
(1,'SECTION','EDITREPORT'),
(2,'SECTION','LISTOFVALUES'),
(3,'SECTION','ANNOTATIONS');

SELECT SETVAL('"Default".ai_dm_applicable_area_id_seq', (SELECT MAX(id) from "Default".ai_dm_applicable_area));

insert into "Default".ai_dm_privilege (id,dm_id,privilegetype,user_rolename,isacknowledged) values
(1,1,'USER','Admin',0),
(2,1,'USER','Demo',0),
(3,2,'USER','Admin',0),
(4,2,'USER','Demo',0),
...
SELECT SETVAL('"Default".ai_dm_privilege_id_seq', (SELECT MAX(id) from "Default".ai_dm_privilege));

Insert into "Default".ai_fileandfolder (id,description,owner,rootfolder,category,path,name,type,versionno,visibilitytype,visible,createdby,createdon,isdefault,lastupdatedon,lastupdatedby,isarchivable,isarchived,ispurgeable,ispurged) values
...
SELECT SETVAL('"Default".ai_annotation_id_seq', (SELECT MAX(id) from "Default".ai_annotation));

Insert into "Default".ai_audit (id,resourceid,resourcetype,actiontype,username,starttime,comments,oldvalues,newvalues) values
...
(154,'103','FILE','CREATE','Admin',now(),'File created successlly',NULL,NULL),
(155,'103','FILE','UPLOAD','Admin',now(),'File uploaded.',NULL,NULL);

 SELECT SETVAL('"Default".ai_audit_id_seq', (SELECT MAX(id) from "Default".ai_audit));

insert into "Default".ai_filefolder_output(fileid,outputtype) values (49,'pdf');

insert into "Default".ai_parameter(id,name,datatype,format,displayname,displaytype,defaultvalue,defaultvaluetype,helptext,isvisible,isrequired,filterby,filtercondition,linkedparam,datasetid,datasetcolumnname,value_displaytext,username) values
(1,'All Country','String','custom','All Country','ListBox',null,'DYNAMIC',null,1,1,'None',null,'None',40,'country','country','Admin');

SELECT SETVAL('"Default".ai_parameter_id_seq', (SELECT MAX(id) from "Default".ai_parameter));

insert into "Default".ai_privilege(id,fileid,privilegetype,user_rolename,privilegevalue) values
...
(26,103,'ROLE','Sales',NULL);

SELECT SETVAL('"Default".ai_privilege_id_seq', (SELECT MAX(id) from "Default".ai_privilege));

INSERT INTO "Default".ai_datasource_type(id, protocol, type_database,driver_class_name,url)
...
SELECT SETVAL('"Default".ai_datasource_type_id_seq', (SELECT MAX(id) from "Default".ai_datasource_type));

INSERT INTO "Default".ai_lovrow_mapping(id,lovId,mapId,rowNo,owner,comments)
VALUES (1,44,86,'0','Admin',null),
(2,44,86,'1','Admin',null),
(3,44,86,'2','Admin',null);

SELECT SETVAL('"Default".ai_lovrow_mapping_id_seq', (SELECT MAX(id) from "Default".ai_lovrow_mapping));


INSERT INTO "Default".ai_department(id,deptName,deptCode)
VALUES (1,'Default','Default');

SELECT SETVAL('"Default".ai_department_id_seq', (SELECT MAX(id) from "Default".ai_department));
